...
public class NVIDIAGTX1060 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delegate.setContentView(R.layout.nvidia_gtx_1060);

        Toolbar toolbar = (Toolbar) findViewById(R.id.my_other_awesome_toolbar);
        ...
        pay_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sdk.requestPayment(280, "787-321-4321", "id12345678", "athmovildemoapp://nvidia", NVIDIAGTX1060.this);
            }
        });
